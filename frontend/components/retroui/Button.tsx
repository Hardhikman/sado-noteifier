  ...
  "font-head transition-all rounded outline-hidden cursor-pointer duration-200 font-medium flex items-center",
  {
    variants: {
      variant: {
        ...
        destructive:
          "shadow-md hover:shadow active:shadow-none bg-red-600 text-white border-2 border-black transition hover:translate-y-1 active:translate-y-2 active:translate-x-1 hover:bg-red-700",
      },
      size: {
